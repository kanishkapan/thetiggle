...
import bgImage from "../../assets/productpageheader.png"; // Make sure the path is correct

const IcedChocolatePromo = () => {
  useEffect(() => {
  ...
  style={{ backgroundColor: "rgba(0, 0, 0, 0.8)" }} // adjust opacity here
></div>
...
export default IcedChocolatePromo;
